...
# Script Author: Zhuang Li, Purdue University    #
...
IMPORT_SECTION = """
  touch import.lock
  echo "Link the movies folder or micrograph folder to import newest data"
  #IMPORT_CMD
  if [ $? -eq 0 ];then
    echo '++++++++++++++++++++++++++++'
    /bin/rm import.lock
...
import_section = IMPORT_SECTION.replace("#IMPORT_CMD", x1)
...
import_section = IMPORT_SECTION.replace("#IMPORT_CMD", y1)
